...
//  VirtualTourist
//
//  Created by Peter Schorn on 8/2/20.
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneWillResignActive(_ scene: UIScene) {
        // Called when the scene will move from an active state
    ...
    func sceneWillEnterForeground(_ scene: UIScene) {
        // Called as the scene transitions from
        // the background to the foreground.
        // Use this method to undo the changes
    ...
    func sceneDidEnterBackground(_ scene: UIScene) {
        ...
        if (UIApplication.shared.delegate as? AppDelegate)?
                .saveContext() == nil {
            
            assertionFailure(
                "sceneDidEnterBackground: couldn't save view context"
            )
        }
    }
